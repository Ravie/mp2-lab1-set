...
TEST(TBitField, bit_operations_with_three_bitfields)
{
	const int size = 6;
	TBitField bf1(size), bf2(size), bf3(size), bf_res1(size), bf_res2(size);
